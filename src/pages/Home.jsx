  ...
  return (
    <div className="relative">
      ...
      <main className="bg-midnight min-h-screen relative">
        <div className="flex flex-col flex-grow justify-center items-center text-center bg-surface-900 text-white px-6">
          <h1 className="text-4xl md:text-6xl font-bold">LFC</h1>
          <p className="mt-4 text-gray-400 max-w-2xl">
            This site was made to help colleges and universities track
            tournaments held in their respective campuses.
          </p>
            ...
            {[
              {
                ...
                desc: "Search and compare players across all leagues.",
              },
              {
                title: "Squad Builder",
                desc: "Create and share your dream team.",
              },
              {
                title: "Live Stats",
                desc: "Track in-game stats and player performance.",
              },
            ].map((feature, index) => (
              <div
                key={index}
