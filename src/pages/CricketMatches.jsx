  ...
  return (
    <div className="min-h-screen bg-midnight text-ice-blue p-10">
      <nav className="flex justify-around bg-gray-800 p-4 mb-6 rounded-lg shadow-lg">
        <Link to="/admin/cricket" className="text-ice-blue font-bold hover:text-yellow-400 transition duration-300">Cricket</Link>
        <Link to="/admin/football" className="text-ice-blue font-bold hover:text-yellow-400 transition duration-300">Football</Link>
        <Link to="/admin/badminton" className="text-ice-blue font-bold hover:text-yellow-400 transition duration-300">Badminton</Link>
      </nav>
